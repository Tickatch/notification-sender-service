...
@AnalyzeClasses(
    packages = "com.tickatch.notificationsenderservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.tickatch.notificationsenderservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.tickatch.notificationsenderservice..presentation..")
        .layer("Application")
        .definedBy("com.tickatch.notificationsenderservice..application..")
        .layer("Domain")
        .definedBy("com.tickatch.notificationsenderservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.tickatch.notificationsenderservice..infrastructure..")
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.tickatch.notificationsenderservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.tickatch.notificationsenderservice.global..")
        .should()
        .dependOnClassesThat()
